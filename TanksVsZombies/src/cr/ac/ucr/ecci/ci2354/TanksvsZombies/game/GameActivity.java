...
public class GameActivity extends SimpleBaseGameActivity implements IAccelerationListener, IOnSceneTouchListener, IOnAreaTouchListener {
	...
	public Scene onCreateScene() {
		...
		autoParallaxBackground
				.attachVerticalParallaxEntity(new VerticalParallaxEntity(-2.0f, new Sprite(0, CAMERA_HEIGHT - this.mFrontLayer.getHeight(), this.mFrontLayer, vertexBufferObjectManager)));
	...
	protected void createMenuScene() {
		...
		final IMenuItem resetMenuItem = new ColorMenuItemDecorator(new TextMenuItem(REGRESAR_INICIO, null, "Volver al inicio", this.getVertexBufferObjectManager()), new Color(1, 0, 0), new Color(0,
				0, 0));
		resetMenuItem.setBlendFunction(GLES20.GL_SRC_ALPHA, GLES20.GL_ONE_MINUS_SRC_ALPHA);
		menuScene.addMenuItem(resetMenuItem);

		final IMenuItem quitMenuItem = new ColorMenuItemDecorator(new TextMenuItem(TERMINAR_PARTIDA, null, "Terminar partida", this.getVertexBufferObjectManager()), new Color(1, 0, 0), new Color(0,
				0, 0));
