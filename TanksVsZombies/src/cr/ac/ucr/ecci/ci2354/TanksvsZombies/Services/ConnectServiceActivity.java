...
public class ConnectServiceActivity extends Activity {
	...
	private void post(int puntuacion) {
		...
		parameters.putString("message", "He conseguido una puntuaci�n de "+puntuacion+" en el juego TANKS vs ZOMBIES");
...
//				}
//			},null);
			Log.d("", "SE LOGR� RESPUESTA ");
			showToast("Se realiz� con �xito la publicaci�n del puntaje en tu muro");
		} catch (Exception e) {
			showToast("Fall� la publicaci�n del puntaje en tu muro");
		}
