...
import cr.ac.ucr.ecci.ci2354.TanksvsZombies.R.string;
...
public class MainMenu extends FragmentActivity implements ActionBar.TabListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0: return getString(R.string.mainMenu).toUpperCase();
                case 1: return getString(R.string.highScores).toUpperCase();
            }
            return null;
        }
    }
    ...
    public static class DummySectionFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
            View lol =((LayoutInflater)getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.mainmenu, null, false);
            return lol;
        }
    }
}
